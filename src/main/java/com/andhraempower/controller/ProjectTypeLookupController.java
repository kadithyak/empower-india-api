...
import com.andhraempower.service.ProjectTypesService;
...
@Slf4j
public class ProjectTypeLookupController {
    ...
    @Operation(summary = "Retrieves all projectTypes.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<ProjectTypeLookup>> getProjectTypes() {
        try {
            List<ProjectTypeLookup> types = projectTypesService.getAllProjectTypes();
